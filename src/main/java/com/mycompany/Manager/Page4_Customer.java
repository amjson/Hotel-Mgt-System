 ...
 * @author JoeAlpha
 */
public class Page4_Customer extends javax.swing.JFrame implements Runnable {
    ...
    private void customers_table() {
        try {
            ...
            Logger.getLogger(Page4_Customer.class.getName()).log(Level.SEVERE, null, ex);
        }            
    }
            ...
            if(dialogResult == JOptionPane.YES_OPTION){
                try {
                    ...
                    if (sqlQueryCheck.executeUpdate() != 0) {
                        ...
                        new Page4_Customer().setVisible(true);
                        this.dispose();
                    }
                } catch (Exception ex) {
                    Logger.getLogger(Page4_Customer.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Page4_Customer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
